...
static const float M_PI_TO_RAD = M_PI / 180.0f;
static const float M_RAD_TO_PI = 180.0f / M_PI;
...
static float Radians(float degrees) { return degrees * M_PI_TO_RAD; }
static float Degrees(float radians) { return radians * M_RAD_TO_PI; }